                ...
                <div className="col-12 col-md-9 ">
                    <Form model="feedback" onSubmit={(values) => this.handleSubmit(values)}>
                        ...
                        <Row className="form-group">
                            ...
                            <Col md={10}>
                                ...
                                <Errors className="text-danger" model=".telnum" show="touched"
                                  messages={{required: 'Required', minLength: "Must be greater than 2 characters", maxLength: "Must be less than or equal 10 characters", isNumber: 'Must be a number!'}}/>
                            </Col>
                        </Row>
                        <Row className="form-group">
                        ...
                        <Row className="form-group">
                            ...
                            <Col md={10}>
                                <Control.textarea model=".message" id="feedback" name="message" rows="8" className="form-control" />
                            </Col>
                        </Row>
                        <Row className="form-group">
